...
export default function TagGenerator() {
  ...
  return (
    <div style={{ maxWidth: '700px', margin: '0 auto', padding: '40px 24px' }}>
      <h2 style={{ fontSize: '22px', fontWeight: 700, color: '#fff', marginBottom: '4px' }}>Tag Generator</h2>
      <p style={{ fontSize: '13px', color: 'rgba(255,255,255,0.45)', marginBottom: '24px' }}>Generate high-SEO tags. Click to deselect any you don't want.</p>
      ...
      {tags.length > 0 && (
        <div>
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '12px' }}>
            <span style={{ fontSize: '13px', color: 'rgba(255,255,255,0.45)' }}>{selectedTags.size} of {tags.length} selected</span>
            <button onClick={copySelected} style={{ padding: '6px 14px', borderRadius: '6px', fontSize: '12px', background: copiedAll ? '#22c55e20' : 'rgba(255,255,255,0.08)', color: copiedAll ? '#22c55e' : 'rgba(255,255,255,0.5)', border: `1px solid ${copiedAll ? '#22c55e40' : 'rgba(255,255,255,0.1)'}`, cursor: 'pointer' }}>
