    ...
    <section style={{ paddingTop: '120px', paddingBottom: '80px', textAlign: 'center', background: '#0a0a0a' }}>
      ...
      <div style={{
        ...
        <div style={{ padding: '24px', background: '#0d0d0d', borderBottom: '1px solid rgba(255,255,255,0.07)', display: 'flex', alignItems: 'center', gap: '8px' }}>
          ...
          <span style={{ marginLeft: '12px', fontSize: '12px', color: 'rgba(255,255,255,0.3)', fontFamily: 'monospace' }}>MoneyMaker — Script Writer</span>
        </div>
        <div style={{ padding: '32px 40px', textAlign: 'left' }}>
          <div style={{ fontSize: '11px', fontWeight: 700, color: 'rgba(255,255,255,0.3)', letterSpacing: '0.08em', textTransform: 'uppercase', marginBottom: '12px' }}>Hook (0–15 seconds)</div>
          <div style={{ fontSize: '15px', color: 'rgba(255,255,255,0.85)', lineHeight: 1.7, marginBottom: '24px', borderLeft: '3px solid #a78bfa', paddingLeft: '16px' }}>
          ...
          <div style={{ fontSize: '11px', fontWeight: 700, color: 'rgba(255,255,255,0.3)', letterSpacing: '0.08em', textTransform: 'uppercase', marginBottom: '12px' }}>Open Loop</div>
          <div style={{ fontSize: '15px', color: 'rgba(255,255,255,0.85)', lineHeight: 1.7, marginBottom: '24px', borderLeft: '3px solid #60a5fa', paddingLeft: '16px' }}>
          ...
          <div style={{ display: 'flex', gap: '8px', flexWrap: 'wrap' }}>
            {['Open Loop', 'Pattern Interrupt', 'Stakes Escalation', 'Curiosity Gap'].map(t => (
              <span key={t} style={{ fontSize: '11px', padding: '4px 10px', borderRadius: '20px', background: 'rgba(167,139,250,0.12)', border: '1px solid rgba(167,139,250,0.25)', color: '#a78bfa' }}>{t}</span>
            ))}
          </div>
        </div>
      </div>
